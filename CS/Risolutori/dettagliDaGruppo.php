...
<html>
    ...
    <body class="ricerca risolutor">
            ...
            <?php if ($_SESSION[$sruolo] == 3) { ?>
                <div id="segnalazione" class="row seconda" style="display: none">
                    ...
                    <div class="col-md-6" >
                        ...
                        <table id="tabellaSegn">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input style="width: 100%" type='text' id='commento' value="">
                                </td>
                            </tr>
                    ...
                    <div class="col-md-6 destra" style="align-items: center;">
                        ...
                        <button class="btn-red" style="width:50%" onclick="rimanda(<?= $row['id'] ?>)">Manda ad ente</button><br>

                        <button class="btn-minGreen mb-3" style="width:50%" type="button" onclick="modifica(<?= $_GET["id"] ?>)">Conferma modifiche</button>
                        <p id="demo"></p>
                    </div>
        ...
        <script src="./js/dettagliDaGruppo.js" type="text/javascript"></script>
        <script>valutaCDT(<?= $_GET["id"] ?>);</script>
    </body>
</html>
